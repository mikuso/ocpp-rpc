...
export type RequestMethod<T extends ProtocolNames, M extends keyof ProtocolMethodsMap[T]> = ProtocolMethodsMap[T][M] extends {
    req: infer R;
} ? R : never;
export type HandlerOptions<T extends ProtocolNames, M extends keyof ProtocolMethodsMap[T]> = {
    method: M;
