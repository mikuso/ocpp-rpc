...
import { createRPCError, getErrorPlainObject, getPackageIdent } from "../lib/util.js";
...
describe('util', function(){
    ...
    describe('getPackageIdent', function(){

        it('should return a string representing the current package version', () => {

            const ident = getPackageIdent();
            
            ok(ident);
            equal(typeof ident, 'string');
