 ...
 * @prop {http.IncomingHttpHeaders} headers The HTTP headers sent in the upgrade request.
 * @prop {http.IncomingMessage} request The full HTTP request received by the underlying webserver.
 */
