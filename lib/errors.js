...
export class RPCError extends Error {
    ...
    /**
     * Sets the rpcErrorCode to the OCPP1.6 deprecated version (if applicable) or not.
     * @internal
     * @param {boolean} useDeprecated 
     * @returns {string}
     */
    asOCPP16Deprecated(useDeprecated) {
...
export class RPCFormatViolationError extends RPCError {
     ...
     */
    asOCPP16Deprecated(useDeprecated) {
        this.rpcErrorCode = useDeprecated ? "FormationViolation" : "FormatViolation";
        return this.rpcErrorCode;
    }
}
...
export class RPCOccurrenceConstraintViolationError extends RPCError {
     ...
     */
    asOCPP16Deprecated(useDeprecated) {
        this.rpcErrorCode = useDeprecated ? "OccurenceConstraintViolation" : "OccurrenceConstraintViolation";
        return this.rpcErrorCode;
    }
}
