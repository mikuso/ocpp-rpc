...
/**
 * @param {string} subprotocol The websocket subprotocol this Validator is targeting
 * @param {* | *[] | string} schemaObjOrPath An array or object containing JSON Schemas. Alternatively, a path to a location where a JSON schema (or schemas) can be found.
 * @param {object} [options] 
