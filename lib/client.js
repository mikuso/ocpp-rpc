 ...
 *
 * @event RPCClient#connecting
 * @memberof RPCClient
 * @type {object}
 * @property {string[]} protocols - The list of subprotocols being offered for this connection attempt.
 */

/**
 * Emitted when the client has successfully connected and is ready to send & receive calls.
 *
 * @event RPCClient#open
 * @memberof RPCClient
 * @type {object}
 * @property {http.IncomingMessage} response - The server's HTTP upgrade response.
 */
 ...
 *
 * @event RPCClient#disconnect
 * @memberof RPCClient
 * @type {object}
 * @property {number} code - The WebSocket close code received.
 * @property {string} reason - The reason for the connection closing.
 */

/**
 * Emitted after client.close() completes. Will not be emitted if the client reconnects.
 *
 * @event RPCClient#close
 * @memberof RPCClient
 * @type {object}
 * @property {number} code - The WebSocket close code received.
 * @property {string} reason - The reason for the connection closing.
 ...
 *
 * @event RPCClient#message
 * @memberof RPCClient
 * @type {object}
 * @property {Buffer|string} message - The message payload.
 * @property {boolean} outbound - True if the message originated locally.
 */
 ...
 *
 * @event RPCClient#call
 * @memberof RPCClient
 * @type {object}
 * @property {string} messageId - The RPC message ID.
 * @property {boolean} outbound - True if the call originated locally.
 * @property {Array} payload - The RPC call payload array.
 */

/**
 * Emitted immediately after a call result is successfully sent or received.
 *
 * @event RPCClient#callResult
 * @memberof RPCClient
 * @type {object}
 * @property {string} messageId - The RPC message ID.
 * @property {boolean} outbound - True if the result originated locally (i.e. sent by this side).
 * @property {string} method - The RPC method name.
 * @property {object} params - The RPC params.
 * @property {object} result - The result of the call.
 */
 ...
 * @property {string} method - The RPC method name.
 * @property {object} params - The RPC params.
 * @property {RPCError|Error} error - The error from the call.
 */
 ...
 *
 * @event RPCClient#response
 * @memberof RPCClient
 * @type {object}
 * @property {boolean} outbound - True if the response originated locally.
 * @property {Array} payload - The RPC response payload array.
 */

/**
 * Emitted when the client has received a response (pong) to a ping.
 *
 * @event RPCClient#ping
 * @memberof RPCClient
 * @type {object}
 * @property {number} rtt - The round trip time in milliseconds between when the ping was sent and the pong was received.
 */
 ...
 *
 * @event RPCClient#badMessage
 * @memberof RPCClient
 * @type {object}
 * @property {Buffer} buffer - The raw discarded "bad" message payload.
 * @property {Error} error - An error describing what went wrong when handling the payload.
 * @property {Array|null} response - A copy of the response sent in reply to the bad message (if applicable).
 */

/**
 * Emitted in strict mode when an inbound call or outbound response fails schema validation.
 *
 * @event RPCClient#strictValidationFailure
 * @memberof RPCClient
 * @type {object}
 * @property {Error} error - The validation error that triggered the strictValidationFailure event.
 * @property {string} messageId - The RPC message ID.
 * @property {string} method - The RPC method name.
 * @property {object} params - The RPC parameters.
 * @property {object|null} result - The invalid result if this relates to a CALLRESULT failure, otherwise null.
 * @property {boolean} outbound - True if the invalid message originated locally.
 * @property {boolean} isCall - True if the invalid message is a CALL type; false indicates a CALLRESULT type.
 */
