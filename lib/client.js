...
const { TimeoutError, UnexpectedHttpResponse, RPCNotImplementedError, RPCFrameworkError, RPCGenericError, RPCMessageTypeNotSupportedError } = require('./errors');
    ...
    _onMessage(buffer) {
        ...
        try {
            ...
            if (typeof messageTypePart !== 'number') {
                throw new RPCFrameworkError("Message type must be a number");
            }
            ...
            if (![MSG_CALL, MSG_CALLERROR, MSG_CALLRESULT].includes(messageTypePart)) {
                throw new RPCMessageTypeNotSupportedError("Unrecognised message type");
            }
        ...
        try {
            ...
            try {
                ...
                if (rpcErrorCode === 'FormatViolation' && this.protocol === 'ocpp1.6') {
                    // work around an error in the spec (clarified in 5.2 of OCPP1.6J errata v1.0)
