 ...
 *
 * @event RPCServer#upgradeAborted
 * @memberof RPCServer
 * @type {object}
 * @property {Error} error - The cause of the abort.
 * @property {net.Socket} socket - Network socket between the server and client.
 * @property {http.IncomingMessage} request - The full HTTP request received by the underlying webserver.
 * @property {string} identity - The identity portion of the connection URL, decoded.
 */
